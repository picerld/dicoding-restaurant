...
const _primaryColor = Color(0xFFFF9800);
const _secondaryColor = Color(0xFFFFC107);
const _deepOrange = Color(0xFFF4511E);
...
final ThemeData lightTheme = ThemeData(
  ...
  typography: Typography(
    ...
    blockQuote: GoogleFonts.poppins(fontSize: 14, fontStyle: FontStyle.italic),
...
final ThemeData darkTheme = ThemeData(
  ...
  typography: Typography(
    ...
    x2Large: GoogleFonts.poppins(fontSize: 20, color: const Color(0xFFFFFFFF)),
    x3Large: GoogleFonts.poppins(fontSize: 24, color: const Color(0xFFFFFFFF)),
    x4Large: GoogleFonts.poppins(fontSize: 28, color: const Color(0xFFFFFFFF)),
    x5Large: GoogleFonts.poppins(
      fontSize: 32,
      fontWeight: FontWeight.bold,
      color: const Color(0xFFFFFFFF),
    ),
    x6Large: GoogleFonts.poppins(fontSize: 36, color: const Color(0xFFFFFFFF)),
    x7Large: GoogleFonts.poppins(fontSize: 40, color: const Color(0xFFFFFFFF)),
    x8Large: GoogleFonts.poppins(fontSize: 48, color: const Color(0xFFFFFFFF)),
    x9Large: GoogleFonts.poppins(fontSize: 56, color: const Color(0xFFFFFFFF)),
